...
function formTypes(){
    ...
    document.querySelector("#games_back").removeEventListener("click", formTypes);

    document.querySelector("#games").classList.add("hidden");
    document.querySelector("#type").classList.remove("hidden");

    //document.querySelector("#type_but").addEventListener("click", formArea);
    //document.querySelector("#types_back").addEventListener("click", formStart);
...
function formArea() {
    ...
    //document.querySelector("#area_back").addEventListener("click", formStart);
...
function formPassword(){
    ...
    document.querySelector("#area_back").removeEventListener("click", formPassword);
